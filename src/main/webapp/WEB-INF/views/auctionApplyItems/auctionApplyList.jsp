			...
			<c:forEach items="${auctionApplys.content}" var="task">
				<tr>
					...
					<td> 
						...
						<a href="#" onclick="confirmPass('${ctx}/auctionApply/approval/${task.id}?status=pass')">审批通过</a>&nbsp;
						<a href="#" onclick="confirmReject('${ctx}/auctionApply/approval/${task.id}?status=reject')">审批拒绝</a>&nbsp;
						</c:if>
					</td>
